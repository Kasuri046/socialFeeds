...
import 'package:socialfeeds/screens/social_feeds/videoplay.dart';
...
class VideosList extends StatelessWidget {
  ...
  const VideosList({Key? key, required this.controller,}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(videosdata[index].imagePath),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: CustomText(
                                    text: videosdata[index].maintext,
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => VideosPage(index: index),
                                    ),
                                  );
                                },
                                child: Container(
                        ...
                        // Likes, Comments, Views, Share Section
                        Container(
                          height: context.screenHeight > 1200 ? 45 : 30,
                          width: context.screenWidth,
                          child: Row(
                            children: [
                              GestureDetector(
                                onTap: () {
                                  controller.onTapVideoPage(index);
                                },
                                child: Obx(() => controller.isCheckedVideosList[index] == false
                                    ? Image.asset(
                              ...
                              SizedBox(width: 5),
                              CustomText(
                                text: videosdata[index].likeCount,
                                color: AppColors.color6,
                                fontSize: context.screenHeight > 1200 ? 20 : 14,
                              ...
                              SizedBox(width: 5),
                              CustomText(
                                text: videosdata[index].viewCount,
                                color: AppColors.color6,
                                fontSize: context.screenHeight > 1200 ? 20 : 14,
                                fontWeight: FontWeight.w600,
                              ),
                              ...
                              SizedBox(width: 5),
                              CustomText(
                                text: videosdata[index].commentCount,
                                color: AppColors.color6,
                                fontSize: context.screenHeight > 1200 ? 20 : 14,
                                fontWeight: FontWeight.w600,
                              ),
                              ...
                              SizedBox(width: 5),
                              CustomText(
                                text: videosdata[index].shareCount,
                                color: AppColors.color6,
                                fontSize: context.screenHeight > 1200 ? 20 : 14,
                                fontWeight: FontWeight.w600,
                              ),
